...
public class GetAccountByIdJerseyExample {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        WebTarget accountsWebTarget = webTarget.path("accounts").path("FI6593857450293470-EURa");
        ...
        if (response.getStatus() == 200) {
            GetAccountResponse getAccountsResponse = response.readEntity(GetAccountResponse.class);
