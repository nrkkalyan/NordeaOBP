(function() {
	...
	var personCtrl = angular.module('FilesController',
			[ 'ThHttpService', 'ngDialog' ])//
	.controller('FilesController', FilesController);

	function FilesController($scope, $window, $http, $filter, ThHttpService, ngDialog,
			ngProgressFactory) {
		$scope.errorMessage = "";
		$scope.th = [];
		...
		$scope.getAvailableFiles = function(senderId, signerId, dateFrom, dateTo, action, fileType, serviceId, maxFiles) {
			console.log('FilesController.getAvailableFiles:', senderId, dateFrom, dateTo, action, fileType, serviceId, maxFiles);
